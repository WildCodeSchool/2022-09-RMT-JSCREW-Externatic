...
function CarteEntreprise({ id }) {
  ...
  return (
    <div className="flex flex-col md:w-6/12 xl:w-5/12 justify-items-center items-center p-4 mx-6 my-5 text-darkPink text-justify border-2 rounded-3xl drop-shadow-xl">
