...
function CarteSalaire({ offre }) {
  return (
    <div className="bganimationcard flex flex-col min-w-full justify-items-center items-center p-4 mx-6 my-5 text-white text-justify border-2 rounded-3xl drop-shadow-xl">
